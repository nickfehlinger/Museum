...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { active: @piece.active, description: @piece.description, location: @piece.location, size: @piece.size, title: @piece.title, value: @piece.value } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { active: @piece.active, description: @piece.description, location: @piece.location, size: @piece.size, title: @piece.title, value: @piece.value } }
